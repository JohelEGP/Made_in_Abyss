...
template <class Qty>
struct hash<mia::Point<2, Qty>> : private hash<mia::Abscissa<Qty>>,
...
template <class Qty>
struct hash<mia::Point<3, Qty>> : private hash<mia::Abscissa<Qty>>,
                                  private hash<mia::Ordinate<Qty>>,
...
template <class Qty>
struct hash<mia::Size<2, Qty>> : private hash<mia::Width<Qty>>,
...
template <class Qty>
struct hash<mia::Size<3, Qty>> : private hash<mia::Width<Qty>>,
                                 private hash<mia::Height<Qty>>,
